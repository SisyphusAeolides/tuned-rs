...
public export
matchingUnitActivates : active (Unit 10 0 True True True) = True
matchingUnitActivates = Refl

public export
cpuinfoMismatchCannotActivate : active (Unit 0 1 True False True) = False
cpuinfoMismatchCannotActivate = Refl

public export
lowerPriorityRunsFirst :
  orderedBefore (Unit 5 3 True True True) (Unit 10 0 True True True) = True
lowerPriorityRunsFirst = Refl

public export
equalPriorityKeepsDeclarationOrder :
  orderedBefore (Unit 10 0 True True True) (Unit 10 2 True True True) = True
